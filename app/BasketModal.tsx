  ...
  return (
    <div style={{
      ...
      <div style={{ background: '#fff', borderRadius: 24, boxShadow: '0 2px 16px #0002', padding: '2rem 1.5rem', minWidth: 340, maxWidth: 420, width: '100%', position: 'relative' }} onClick={e => e.stopPropagation()}>
        <button onClick={onClose} style={{ position: 'absolute', top: 12, right: 16, background: 'none', border: 'none', fontSize: 22, color: '#ff6e7f', cursor: 'pointer', fontWeight: 700 }}>×</button>
        ...
        {cart.length === 0 ? (
          ...
          <>
            ...
            <div style={{ fontWeight: 600, fontSize: 18, marginTop: 16, color: '#f96e46' }}>Total: €{total}</div>
            <button
              onClick={clearCart}
